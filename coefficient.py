...
def coefficient(thr_ct, smoothing, nside, itr, b):
...
def coefficient_simplified(thr_ct, smoothing, nside, itr, b):
...
def coefficient_cov_fix(thr_ct, smoothing, nside, itr, b):
